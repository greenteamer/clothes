...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'OrderOneClick.product'
        raise RuntimeError("Cannot reverse this migration. 'OrderOneClick.product' and its values cannot be restored.")
