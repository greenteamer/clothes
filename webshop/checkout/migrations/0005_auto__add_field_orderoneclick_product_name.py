...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrderOneClick.product_name'
        db.add_column('checkout_orderoneclick', 'product_name',
                      self.gf('django.db.models.fields.CharField')(default=2, max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrderOneClick.product_name'
        db.delete_column('checkout_orderoneclick', 'product_name')
