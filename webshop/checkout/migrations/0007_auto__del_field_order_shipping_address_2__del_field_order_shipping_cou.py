...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Order.shipping_country'
        raise RuntimeError("Cannot reverse this migration. 'Order.shipping_country' and its values cannot be restored.")
