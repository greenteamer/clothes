...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Product.old_price'
        db.alter_column('products', 'old_price', self.gf('django.db.models.fields.DecimalField')(max_digits=9, decimal_places=0))

    def backwards(self, orm):

        # Changing field 'Product.old_price'
        db.alter_column('products', 'old_price', self.gf('django.db.models.fields.DecimalField')(max_digits=9, decimal_places=2))
    ...
    models = {
        ...
        'catalog.product': {
            ...
            'old_price': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '9', 'decimal_places': '0', 'blank': 'True'}),
            'price': ('django.db.models.fields.DecimalField', [], {'max_digits': '9', 'decimal_places': '0'}),
